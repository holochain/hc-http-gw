...
impl From<String> for JsonErrorResponse {
    fn from(value: String) -> Self {
        Self { error: value }
    }
}

impl From<&str> for JsonErrorResponse {
        ...
        match self {
            HcHttpGatewayError::PathError(e) => {
                ...
                (
                    ...
                    Json(JsonErrorResponse::from("Invalid request path")),
                )
            }
            ...
            HcHttpGatewayError::DnaHashError(e) => {
                ...
                (
                    StatusCode::BAD_REQUEST,
                    Json(JsonErrorResponse::from("Invalid base64 DNA hash")),
                )
            }
            HcHttpGatewayError::InvalidJSON(e) => {
                ...
                (
                    StatusCode::BAD_REQUEST,
                    Json(JsonErrorResponse::from("Payload contains invalid JSON")),
                )
            }
            ...
            e => {
                ...
                (
                    ...
                    Json(JsonErrorResponse::from("Something went wrong")),
                )
            }
        }
        .into_response()

...
use holochain_client::{
    AdminWebsocket, AllowedOrigins, AppWebsocket, AuthorizeSigningCredentialsPayload, CellInfo,
    ClientAgentSigner, ConnectRequest, GrantedFunctions, InstalledAppId,
    IssueAppAuthenticationTokenPayload, WebsocketConfig,
};
...
const HTTP_GW_ORIGIN: &str = "hc-http-gw";
